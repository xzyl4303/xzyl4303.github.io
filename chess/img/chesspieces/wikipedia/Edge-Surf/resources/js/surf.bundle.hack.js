    ...
    t = {
      ...
      13695: (e, t, s) => {
        ...
        class ze extends ve {
          ...
          slow() {
            (this.speed.raw *= 1.0), Me.sys.setVibration("slow");
          }
          crash() {
              Me.sys.setVibration("tiny");
          }
          ...
          boost(e = !1) {
            (!e && (te.sys.game.boosts.current <= 0 || "boost" in this.dist)) ||
              ...
              (this.dist.boost = 2e3),
              (this.speed.max = this.speed.base + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd + this.speed.boostAdd),
              ue.sys.refreshDisplay(),
            ...
            if (
              (this.boostFx.length > 0 &&
                (this.boostFx.forEach((e) => {
                  (e.start.x -= 20.8 * this.speed.x),
                    (e.end.x -= this.speed.x),
                    (e.start.y -= 20.8 * this.speed.y),
              ...
              this.boostFx.push({
                start: {
                  ...
                  x: this.x + e - 30 * this.speed.x,
                  y: this.y + 8 - 30 * this.speed.y,
                },
                time: 0.01,
              });
            }
              ...
              if (!this.collision(e, a) || a.hit || t)
                "gate" === a.type && !a.hit && a.y < e.y
                  ...
                  : "lure" === a.type &&
                    a.hit &&
                    a.y + 192 < e.y &&
                    (ke.sys.buildObject("npc", a.x, a.y + 32, "chase"),
                    (a.sleep = !0));
              else {
                if (((a.hit = !0), e.swapped))
                  return (
                    "lure" === a.type &&
                      ke.sys.buildObject("npc", a.x, a.y, "chase"),
                    void (a.sleep = !0)
                  );
                switch (a.type) {
                  case "wall":
